<x-app-layout>
    <x-slot name="header">
        <h2 class="text-xl font-semibold leading-tight text-gray-800">Editar Prompt</h2>
    </x-slot>
    <div class="py-6">
            ...
            <div class="bg-white shadow-sm sm:rounded-lg p-6">
                <form action="{{ route('admin.prompts.update', $prompt) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="prompt" rows="8" class="w-full border rounded p-2" required>{{ $prompt->prompt }}</textarea>
                    </div>
